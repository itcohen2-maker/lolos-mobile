...
export const he: Record<string, string> = {
  ...
  'toast.tripleDice': 'שלישייה של {{n}}! בונוס למד ההצטיינות! ⭐',
  // Excellence-meter reward reasons — shown in a bubble on TurnTransition
  // so the player understands why the meter just advanced.
  'courage.reason.tripleDice': 'קיבלת תוספת למד ההצטיינות — גלגלת שלישייה של {{n}} בקוביות!',
  ...
  'start.rules.c3': '8. שלישייה בקוביות: השחקן שהטיל מקבל בונוס למד ההצטיינות.',
  ...
  'start.advancedSetup.modalLead': 'מד ההצטיינות יתמלא בכל פעם שתיבנו תרגיל מכל תוצאות הקוביות והצלחות פעמיים ברצף. כך תצברו מטבעות.',
