...
export const he: Record<string, string> = {
  ...
  'lobby.timerCustomHint': 'שניות לתור (10–600)',
  ...
  'gameTip.buildEquation': 'טיפ: צור תרגיל ממספרי הקוביות (אפשר להשתמש ב־2 או 3 קוביות).',
  'gameTip.pickSum': 'טיפ: בחר קלפים שסכומם {{n}} ולחץ "הנח קלפים".',
  ...
  'onb.buildEquation.body': 'לחץ על קובייה → בחר סלוט → התוצאה חייבת להתאים לקלף ביד',
  ...
  'equation.buildTitle': 'צור תרגיל ממספרי הקוביות',
