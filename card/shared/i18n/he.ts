...
export const he: Record<string, string> = {
  ...
  'mp.connectingTitle': 'מתחברים לחדר',
  'mp.connectingBody': 'רק רגע — פותחים לך חדר…',
  'mp.connectError':
  ...
  'lobby.advancedToggleShow': 'לחץ להגדרות מתקדמות',
  ...
  'lobby.tablesSubtitle': 'בחר/י שולחן פנוי או פתח/י שולחן חדש.',
  ...
  'lobby.countdownCta': 'התחל בעוד 10 שניות',
  ...
  'mode.howToPlay': 'מדריך בפעולה / בונוס',
  ...
  'ui.welcomeHowBody': 'המטרה היא להפטר מכל הקלפים, ומי שנשאר עם 2 קלפים מנצח.\nלעוד הסברים עברו להדרכה.',
  ...
  'tutorial.multiPlayGiftZero.body': 'אתה יכול להוסיף גם את קלף 0. הוא קלף מתנה',
  ...
  'tutorial.identicalMulti.body': 'אפשר להפטר בתור ביותר מקלף אחד. בואו ננסה.',
  ...
  'lobby.startBotGame': 'התחל משחק מול בוט',
  ...
  'tutorial.fan.guide': 'הזיזו את המניפה ימינה/שמאלה ואז לחצו על קלף כמו הבוט.',
  ...
  'tutorial.l4c.hintPickCards': 'בחרו קלף שווה לתוצאה של התרגיל',
  ...
  'tutorial.welcome.coreReward': 'בסיום ההדרכה הבסיסית תרוויחו 10 מטבעות',
  'tutorial.welcome.advancedReward': 'המשיכו למתקדמים ותרוויחו עוד 20 מטבעות',
  ...
  'tutorial.l9.chooseCard': 'בחרו קלף מהמניפה שמתאים לתוצאה, ואז לחצו בחרתי',
  ...
  'shop.slindaCard.description': 'קלף קסם. הוסף אותו ליד שלך בכל זמן שתרצה, בכל משחק — לצמיתות.',
  ...
  'slindaBank.bubbleTitle': 'בחר קלף להחלפה',
  'slindaBank.bubbleBody': 'לחץ על קלף אחד מהיד בתוך 10 שניות כדי להחליף אותו בסלינדה.',
