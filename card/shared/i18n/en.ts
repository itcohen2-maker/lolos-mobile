...
export const en: Record<string, string> = {
  ...
  'lobby.tablesSubtitle': 'Pick an open table or create your own.',
  ...
  'lobby.countdownCta': 'Start in 10 seconds',
  ...
  'tutorial.multiPlayExerciseMore.hint': 'Choose more than two cards whose sum is {{n}}',
  ...
  'tutorial.multiPlayGiftZero.body': 'You can add 0 along the way. It is a free extra card.',
  ...
  'tutorial.l4c.hintPickCards': 'Choose a card equal to the result of the equation',
  ...
  'slindaBank.bubbleTitle': 'Choose a card to replace',
  'slindaBank.bubbleBody': 'Tap one card from your hand within 10 seconds to swap it with Slinda.',
