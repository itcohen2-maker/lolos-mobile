...
export const en: Record<string, string> = {
  ...
  'lobby.advancedToggleShow': 'Advanced host settings (fractions, helpers, timer…)',
  ...
  'start.advancedSetup.modalLead':
    'Everything for the next game in one place — including the same options that also appear in the bottom wheel. Four numbered sections from top to bottom.',
  'start.advancedSetup.sectionPlayModeHeading': 'Play mode & vs bot',
  'start.advancedSetup.sectionPlayModeIntro':
    'Same choices as the bottom wheel row — changes here or there apply to the same next game.',
  ...
  'start.advancedSetup.hint.fractionsRow':
    'With fractions: fraction cards can appear in the deck. Without: whole numbers only.',
  ...
  'botOffline.fractionDefenseThinkBody': 'I was challenged. Checking if I have a fraction card or a number divisible by {{x}}.',
  ...
  'botOffline.explain.fractionBlock': '{{name}} blocks with a fraction card and passes the challenge.',
  'botOffline.explain.defendNumber': '{{name}} defends with a number divisible by {{penalty}}.',
  'botOffline.explain.defendWild': '{{name}} defends with a wild set to {{value}}, divisible by {{penalty}}.',
